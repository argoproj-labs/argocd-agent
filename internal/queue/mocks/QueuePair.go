...
func (_m *QueuePair) SendQ(name string) queue.WorkQueue {
	ret := _m.Called(name)
...
func (_c *QueuePair_SendQ_Call) Return(_a0 queue.WorkQueue) *QueuePair_SendQ_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *QueuePair_SendQ_Call) RunAndReturn(run func(string) queue.WorkQueue) *QueuePair_SendQ_Call {
	_c.Call.Return(run)
	return _c
}
