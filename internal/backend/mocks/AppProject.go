...
func (_m *AppProject) Create(ctx context.Context, app *v1alpha1.AppProject) (*v1alpha1.AppProject, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *v1alpha1.AppProject) (*v1alpha1.AppProject, error)); ok {
		return rf(ctx, app)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *v1alpha1.AppProject) *v1alpha1.AppProject); ok {
		r0 = rf(ctx, app)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *v1alpha1.AppProject) error); ok {
		r1 = rf(ctx, app)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *AppProject_Expecter) Delete(ctx interface{}, name interface{}, namespace interface{}, deletionPropagation interface{}) *AppProject_Delete_Call {
	return &AppProject_Delete_Call{Call: _e.mock.On("Delete", ctx, name, namespace, deletionPropagation)}
}
...
func (_m *AppProject) Get(ctx context.Context, name string, namespace string) (*v1alpha1.AppProject, error) {
	...
	var r0 *v1alpha1.AppProject
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (*v1alpha1.AppProject, error)); ok {
		return rf(ctx, name, namespace)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) *v1alpha1.AppProject); ok {
...
func (_e *AppProject_Expecter) Get(ctx interface{}, name interface{}, namespace interface{}) *AppProject_Get_Call {
	return &AppProject_Get_Call{Call: _e.mock.On("Get", ctx, name, namespace)}
}
...
func (_m *AppProject) List(ctx context.Context, selector backend.AppProjectSelector) ([]v1alpha1.AppProject, error) {
	...
	var r0 []v1alpha1.AppProject
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, backend.AppProjectSelector) ([]v1alpha1.AppProject, error)); ok {
		return rf(ctx, selector)
	}
	if rf, ok := ret.Get(0).(func(context.Context, backend.AppProjectSelector) []v1alpha1.AppProject); ok {
		r0 = rf(ctx, selector)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]v1alpha1.AppProject)
	...
	if rf, ok := ret.Get(1).(func(context.Context, backend.AppProjectSelector) error); ok {
		r1 = rf(ctx, selector)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *AppProject_Expecter) List(ctx interface{}, selector interface{}) *AppProject_List_Call {
	return &AppProject_List_Call{Call: _e.mock.On("List", ctx, selector)}
}

func (_c *AppProject_List_Call) Run(run func(ctx context.Context, selector backend.AppProjectSelector)) *AppProject_List_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(backend.AppProjectSelector))
	})
	return _c
}
...
func (_m *AppProject) Patch(ctx context.Context, name string, namespace string, patch []byte) (*v1alpha1.AppProject, error) {
	...
	var r0 *v1alpha1.AppProject
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, []byte) (*v1alpha1.AppProject, error)); ok {
		return rf(ctx, name, namespace, patch)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, []byte) *v1alpha1.AppProject); ok {
...
func (_e *AppProject_Expecter) Patch(ctx interface{}, name interface{}, namespace interface{}, patch interface{}) *AppProject_Patch_Call {
	return &AppProject_Patch_Call{Call: _e.mock.On("Patch", ctx, name, namespace, patch)}
}
...
func (_e *AppProject_Expecter) StartInformer(ctx interface{}) *AppProject_StartInformer_Call {
	return &AppProject_StartInformer_Call{Call: _e.mock.On("StartInformer", ctx)}
}
...
func (_e *AppProject_Expecter) SupportsPatch() *AppProject_SupportsPatch_Call {
	return &AppProject_SupportsPatch_Call{Call: _e.mock.On("SupportsPatch")}
}
...
func (_e *AppProject_Expecter) Update(ctx interface{}, app interface{}) *AppProject_Update_Call {
	return &AppProject_Update_Call{Call: _e.mock.On("Update", ctx, app)}
}
