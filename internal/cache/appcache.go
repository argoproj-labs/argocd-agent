...
// SetApplicationSpecCache inserts/updates app spec in cache
func SetApplicationSpecCache(sourceUID types.UID, app v1alpha1.ApplicationSpec) {
...
// GetApplicationSpecCache returns cached app spec
func GetApplicationSpecCache(sourceUID types.UID) (v1alpha1.ApplicationSpec, bool) {
...
// DeleteApplicationSpecCache removes app spec from cache
func DeleteApplicationSpecCache(sourceUID types.UID) {
	appSpecCache.lock.Lock()
	defer appSpecCache.lock.Unlock()
