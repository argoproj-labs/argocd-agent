...
--certificate-github-workflow-repository "argoprojlabs/argocd-agent" --certificate-identity-regexp https://github.com/argoprojlabs/argocd-agent/.github/workflows/release.yaml@refs/tags/v \
...
slsa-verifier verify-image quay.io/argoprojlabs/argocd-agent:vX.Y.Z \
    --source-uri github.com/argoprojlabs/argocd-agent \
    --source-tag vX.Y.Z
```
