...
func EnableSelfClusterRegistration(ctx context.Context, principalClient, agentClient KubeClient) error {
...
func DisableSelfClusterRegistration(ctx context.Context, client KubeClient) error {
