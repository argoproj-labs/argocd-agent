...
func (suite *TerminalStreamingTestSuite) Test_SelfRegisteredSecret_Terminal() {
	...
	requires.NoError(fixture.EnableSelfClusterRegistration(suite.Ctx, suite.PrincipalClient, suite.ManagedAgentClient))
	defer func() {
		// Disable self-registration
		_ = fixture.DisableSelfClusterRegistration(suite.Ctx, suite.PrincipalClient)
